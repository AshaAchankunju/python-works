...
# how many movies released year wise and the maximum of year that release
# year_count={}
# for mov in movies:
#     year=mov.get("year")
...
# # 2--- print all movie name
# for mov in movies:
#     print(mov.get("title"))

#  3--- print movie names whose run time>130
# runtime=[m.get("title")for m in movies if int(m.get("runtime"))>130]
# print(runtime)

# 4--- print movie names whose run time==130
# for mov in movies:
#     if int(mov.get("runtime"))==130:
#         print(mov.get("title"))                     
     
# 5--- print movie names whos genre contain both comedy and drama
# for mov in movies:
#      if "Comedy" in mov.get("genres") and "Drama" in mov.get("genres"):
#         # print(mov.get("title"))

#  6--- print comedy movie names
# for mov in movies:
#     if "Comedy" in mov.get("genres"):
#         print(mov.get("title"))

# 7--- highest runtime movie:
# for m in movies:
# highest_runtimme=max(movies, key=lambda d:int(d.get("runtime")))
# print(highest_runtimme.get("title"))
#     nm=max(most_runtime)
#     print(nm.get("title"))

# "year"==2015
# for m in movies:
#     if int(m.get("year"))==2015:
#         print(m.get("title"))


# film_id=int(input("enter the film id:"))
# for m in movies:
#     if film_id==m.get("id"):
#         print(m.get("title"))


# sci_drama=[m.get("title") for m in movies if "Sci-Fi" in m.get ("genres") and "Drama" in m.get("genres")]
# print(sci_drama)

# most movies focusing genre
genre_count={}
for m in movies:
    gen=(m.get("genres"))
    for g in gen:
        if g in genre_count:
            ...
            genre_count[g]=1
print(genre_count)
highest_gen=[(v,k) for k,v in genre_count.items()]    
print(max(highest_gen))